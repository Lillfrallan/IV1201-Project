...
//        Optional<Person> personOpt = Optional.ofNullable(personRepository.findByUsername(username));
//
//        // Try to find by email if not found by username
//        boolean foundByEmail = false;
//        if (!personOpt.isPresent()) {
//            personOpt = Optional.ofNullable(personRepository.findByEmail(username));
